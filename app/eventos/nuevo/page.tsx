    ...
    <form onSubmit={handleFormSubmit} className="space-y-6">
      ...
      <div className="flex gap-4 pt-2">
        <button
          type="button"
          onClick={() => router.back()}
          className="flex-1 border border-gray-200 py-4 rounded-2xl font-medium text-gray-700 hover:bg-gray-50 transition"
        >
          Cancelar
        </button>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="flex-1 bg-black text-white py-4 rounded-2xl font-medium hover:bg-gray-800 transition disabled:opacity-70 shadow-sm"
        >
          {isLoading ? "Creando evento..." : "Crear Evento e Ir a Pagar"}
        </button>
      </div>
    </form>
  </div>
